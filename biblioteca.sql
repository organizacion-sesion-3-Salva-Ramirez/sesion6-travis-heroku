...
CREATE TABLE IF NOT EXISTS `tvseries` (
  ...
  `name` TEXT COLLATE utf8_spanish_ci NOT NULL,
  `description` TEXT COLLATE utf8_spanish_ci NOT NULL,
  `channelPlatform` TEXT COLLATE utf8_spanish_ci NOT NULL,
  `category` TEXT COLLATE utf8_spanish_ci NOT NULL,
  `seasons` TEXT COLLATE utf8_spanish_ci NOT NULL,
  `language` TEXT COLLATE utf8_spanish_ci NOT NULL,
  `episodes` TEXT COLLATE utf8_spanish_ci NOT NULL,
  `datePublished` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
('Game of thrones', 'Game of thrones: Serie basada en la trilogia cancion de hielo y fuego.', 'HBO', 'Genero Fantastico' ,'7 temporadas', 'Ingles', '67 episodios', '2011-03-17'),
('The big bang theory', 'The big bang theory :Comedia basada en la convivencia de unos freakis','CBS', 'Comedia', '12 temporadas', 'Ingles', '150 episodios', '2007-09-24'),
('Breaking Bad', 'Breaking Bad: Drama violento sobre la transformación de las personas en función de las circunstancias que las rodean.', 'AMC', 'Drama violento.', '5 Temporadas', 'Ingles', '62 Episodios', '2008-01-20');
